...
class form_registraBlog(forms.Form):
    titulo = forms.CharField(max_length=100,label='Titulo del blog')
    subtitulo = forms.CharField(max_length=100, label='Subtitulo del blog')
    blogCompleto = forms.CharField(max_length=1000, label='Escribe el blog',widget= forms.Textarea())
    imagenBlog = forms.ImageField(label='Sube una imagen')
